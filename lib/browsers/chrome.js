      ...
      .then(() => {
        ...
        function startCheckingHealth() {
          ...
          const execTabHealthCheck = async () => {
            ...
            //util.debug(`executing tab healthcheck url=${url}`);
            ...
            tab.Runtime.evaluate({
              ...
              //util.debug(`tab healthcheck success in ${Date.now() - started}ms count=${count} url=${url}`);
              ...
              util.log(`tab healthcheck failed in ${Date.now() - started}ms err=${err}, url=${url}`);
              rejectByTabHealth();
            })
            ...
            tabHealthFailTimout = setTimeout(() => {
              ...
              util.log(`tab healthcheck failed by timeout url=${url}`);
              rejectByTabHealth();
          ...
          const rejectByTabHealth = () => {
              ...
              util.log(`tab healthcheck rejected after ${Date.now() - healthCheckStarted}ms tabHealthLastSuccessValue=${tabHealthLastSuccessValue} url=${url}`);
        ...
        util.log(`Start checking health for tab url=${url}`)
