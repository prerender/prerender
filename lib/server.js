...
var DEFAULT_PHANTOM_ARGUMENTS = ['--load-images=false', '--ignore-ssl-errors=true'];

var DEFAULT_PHANTOM_BASE_PORT = 12300;
...
server.createPhantom = function() {
    ...
    var port = this.options.phantomBasePort || DEFAULT_PHANTOM_BASE_PORT;
    phantom.create( this.options.phantomArguments || DEFAULT_PHANTOM_ARGUMENTS, {
        binary: require('phantomjs').path,
        port: port + this.options.worker.id + 1,
        onExit: function() {
            _this.phantom = null;
...
server.onPhantomPageCreate = function(req, res) {
    ...
    req.prerender.page.set('onResourceRequested', _.bind(_this.onResourceRequested, _this, req, res));
    ...
    req.prerender.page.get('settings.userAgent', function(userAgent) {
        ...
        _this._pluginEvent("onPhantomPageCreate", [req, res], function() {
...
server.onResourceRequested = function (req, res, requestData) {
