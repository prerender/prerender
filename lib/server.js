...
var DISK_CACHE_ENABLED = process.env.DISK_CACHE_ENABLED || true;
...
server.createPhantom = function() {
    ...
    var args = {'--load-images': false, '--ignore-ssl-errors': true, '--ssl-protocol': 'tlsv1.2', '--disk-cache': DISK_CACHE_ENABLED};
