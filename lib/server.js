...
PrerenderServer.prototype.onRequest = function(req, res) {
    ...
    res.sendContent = _.bind(this._sendContent, this, res);
...
PrerenderServer.prototype._sendContent = function(res, content) {
    console.log('send gzip', this.options.gzip);
    if (this.options.gzip) {
        var zipped = Array.prototype.slice.call(new Buffer(content, 'base64'), 0);
        var unzipped = gzip.unzip(zipped);
        content = new Buffer(unzipped).toString('utf8');
    }
