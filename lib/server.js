...
server.addRequestToInFlight = function(req) {
	this.browserRequestsInFlight.set(req.prerender.requestId, req.prerender.url);
};



server.removeRequestFromInFlight = function(req) {
	this.browserRequestsInFlight.delete(req.prerender.requestId);
};
...
server.isThisTheOnlyInFlightRequest = function(req) {
	return this.browserRequestsInFlight.size === 1 && this.browserRequestsInFlight.has(req.prerender.requestId);
}
...
server.onRequest = function(req, res) {
	...
	req.prerender.requestId = uuidv4();
