...
server.checkIfJavascriptTimedOut = function(req, res) {
    ...
    var noJsExecutionInFirstTwoSeconds = new Date().getTime() - req.prerender.downloadFinished.getTime() > 2000;

    if (timeout && lastJsExecutionWasLessThanTwoSecondsAgo) {
    ...
    } else if ((timeout && req.prerender.stage < 2) || noJsExecutionInFirstTwoSeconds) {
