...
var PHANTOM_DISK_CACHE_ENABLED = process.env.PHANTOM_DISK_CACHE_ENABLED || true;

var PHANTOM_MAX_DISK_CACHE_SIZE = process.env.PHANTOM_MAX_DISK_CACHE_SIZE || -1;
...
server.createPhantom = function() {
    ...
    var args = {'--load-images': false, '--ignore-ssl-errors': true, '--ssl-protocol': 'tlsv1.2', '--disk-cache': PHANTOM_DISK_CACHE_ENABLED, '--max-disk-cache-size': PHANTOM_MAX_DISK_CACHE_SIZE};
