...
server.onPhantomPageCreate = function(req, res) {
    ...
    req.prerender.page.run(_this.options.blockedResources || blockedResources, function(blockedResources, resolve, reject) {
...
server.checkIfPageIsDoneLoading = function(req, res, force) {
    ...
    req.prerender.page.run(function(resolve) {
        ...
        if(req.prerender.stage < 1 && (force || (req.prerender.status !== null && req.prerender.pendingRequests <= 0 && (timeSinceLastRequest > (req.prerender.waitAfterLastRequest || _this.options.waitAfterLastRequest || WAIT_AFTER_LAST_REQUEST))) || timedOut)) {
