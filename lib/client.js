...
PrerenderClient.prototype._getContent = function(context) {
    var content = context.response.documentHTML;
    if (this.options.gzip) {
        var zipped = gzip.zip(content);
        var base64Zipped = new Buffer(zipped).toString('base64');
        content = base64Zipped;
    }
    return content;
};
