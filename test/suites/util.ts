...
describe('Util', function() {
	...
	it('should remove the / from the beginning of the URL if present', function() {
		...
		const url = util.getUrl('/http://www.example.com/');
	...
	it('should return the correct URL for #! URLs without query strings', function() {
		...
		const url = util.getUrl('http://www.example.com/?_escaped_fragment_=/user/1');
	...
	it('should return the correct URL for #! URLs with query strings', function() {
		...
		const url = util.getUrl('http://www.example.com/?_escaped_fragment_=/user/1&param1=yes&param2=no');
	...
	it('should return the correct URL for #! URLs if query string is before hash', function() {
		...
		const url = util.getUrl('http://www.example.com/?param1=yes&param2=no&_escaped_fragment_=/user/1');
	...
	it('should return the correct URL for #! URLs that are encoded with another ?', function() {
		...
		const url = util.getUrl('http://www.example.com/?_escaped_fragment_=%2Fuser%2F1%3Fparam1%3Dyes%26param2%3Dno');
	...
	it('should return the correct URL for html5 push state URLs', function() {
		...
		const url = util.getUrl('http://www.example.com/user/1?_escaped_fragment_=');
	...
	it('should return the correct URL for html5 push state URLs with query strings', function() {
		...
		const url = util.getUrl('http://www.example.com/user/1?param1=yes&param2=no&_escaped_fragment_=');
	...
	it('should fix incorrect html5 URL that Bing accesses', function() {
		...
		const url = util.getUrl('http://www.example.com/?&_escaped_fragment_=');
	...
	it('should encode # correctly in URLs that do not use the #!', function() {
		...
		const url = util.getUrl('http://www.example.com/productNumber=123%23456?_escaped_fragment_=');
	...
	it('should not encode non-english characters', function() {
		...
		const url = util.getUrl('http://www.example.com/كاليفورنيا?_escaped_fragment_=');
